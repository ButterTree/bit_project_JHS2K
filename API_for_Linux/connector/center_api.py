...
def let_me_shine():
    url_base = "http://222.106.22.97:55055/let_me_shine/results/?uid="
    ...
    try:
        ...
        if not data['origin']:
            ...
            # item = {'label': data.get('label'), 'origin': data.get('origin')}
...
if __name__ == "__main__":
    ...
    app.run('222.106.22.97', port=55055, debug=True)  # 생성한 'app' 객체를 Parameter 값들을 이용해 구동한다.
